...
* Enviroment
  - GNU Emacs 28.0.50 (build 1, x86_64-pc-linux-gnu, GTK+ Version 3.24.20, cairo version 1.17.3) of 2020-06-12
  - system-configuration-options: ~--with-xwidgets --with-x-toolkit=gtk3
...
** Features like auto complete, go to definitions, documentation on hover
  ...
  - [X] =Julia= (v1.4) pkg> add LanguageServer
...
** Or Install gccemacs, Bringing GNU Emacs to Native Code
