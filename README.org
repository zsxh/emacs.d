...
* Enviroment
  - GNU Emacs 28.0.50 (build 1, x86_64-pc-linux-gnu, GTK+ Version 3.24.29, cairo version 1.17.4) of 2021-07-25
  - build branch: master cb28b2
  - system-configuration-options: ~--with-x-toolkit=gtk3 --with-native-compilation --with-imagemagick~
  - OS: Manjaro 21.1.0 Pahvo
  - Shell: zsh 5.8
  - Kernel: 5.10.47-1-MANJARO
  - DE: Deepin 20.1
  - WM: KWin
