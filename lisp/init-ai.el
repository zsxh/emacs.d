...
(use-package gptel
  ...
  (setq gptel-code-review-format "Review the following code snippet. Identify potential issues, suggest improvements, and explain your reasoning. %sFocus on:\n1. Code quality and maintainability\n2. Performance optimizations\n3. Security considerations\n4. Best practices adherence\n5. Error handling and edge cases\n\nProvide clear, actionable feedback. Format your response with:\n- A summary of key issues\n- Detailed explanations for each issue\n- Specific improvement suggestions\n- Code examples where applicable\n\nKeep the tone professional and constructive. If the code is well-written, acknowledge its strengths while still suggesting potential enhancements.\n\nBelow is the code to review:"
        ...
        gptel-code-explain-format "Explain the functionality and logic of the provided code in a clear and concise manner. %sFocus on:  1. **Purpose**: What is the overall goal or objective of the code?  2. **Key Components**: Identify and describe the main functions, methods, or classes, and their roles in the code.  3. **Workflow**: How does the code execute step by step? Highlight any critical loops, conditionals, or data transformations.  4. **Inputs and Outputs**: Specify what inputs the code expects and what outputs it produces.  5. **Dependencies**: Mention any external libraries, modules, or APIs the code relies on.  6. **Edge Cases**: Discuss any potential edge cases or scenarios that the code handles (or might fail to handle).  7. **Optimization or Improvements**: Suggest any possible optimizations or enhancements to improve the code's performance, readability, or maintainability.  Ensure your explanation is accessible to a broad audience, including those with varying levels of technical expertise. Use examples or analogies where helpful to clarify complex concepts."
        gptel-code-explain-directive (format gptel-code-explain-format "")
        gptel-code-explain-zh-directive (format gptel-code-explain-format " in Chinese"))
  ...
  (setq gptel-directives `((default . "")
                           ...
                           (code-explain-zh . ,gptel-code-explain-zh-directive)
