...
;; Keywords: vc
;; URL: https://github.com/mrunhap/.emacs.d/blob/master/site-lisp/gptel-commit.el
...
;; NOTE: https://www.conventionalcommits.org
(defconst gptel-conventionalcommits-prompt
...
(defun gptel-commit ()
  ...
  (let* ((lines (magit-git-lines "diff" "--cached"))
    ...
    (gptel-request changes :system gptel-conventionalcommits-prompt :stream t)))
